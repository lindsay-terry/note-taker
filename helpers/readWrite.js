...
const createNote = async (req, res) => {
  ...
  if (title && text) {
    ...
    try {
        ...
        //writes db file with updated notes and updates screen with created note
...
//function to delete note using unique ID
const deleteNote = async (req, res) => {
    ...
    if (index !== -1) {
        ...
        //sends success message back to client to update screen immediately
